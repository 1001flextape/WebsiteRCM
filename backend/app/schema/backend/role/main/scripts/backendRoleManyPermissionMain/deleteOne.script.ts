  ...
  return async (args: input): Promise<returningSuccessObj<Model<backendRoleManyPermission> | null>> => {
    ...
    if (!permissionId) {
      return endMainFromError({
        ...
        errorIdentifier: "backendRoleManyPermission_deleteOne_error:0001"
      })
    }
    ...
    if (!isPermissionIdUuid.result) {
      return endMainFromError({
        ...
        errorIdentifier: "backendRoleManyPermission_deleteOne_error:0002"
      })
    }
    ...
    if (!roleId) {
      return endMainFromError({
        ...
        errorIdentifier: "backendRoleManyPermission_deleteOne_error:0003"
      })
    }
    ...
    if (!isRoleIdUuid.result) {
      return endMainFromError({
        ...
        errorIdentifier: "backendRoleManyPermission_deleteOne_error:0004"
      })
    }
    ...
    if (!isPermissionIdValid.result) {
      return endMainFromError({
        hint: "Datapoint 'roleId' is not valid UUID.",
        errorIdentifier: "backendRoleManyPermission_deleteOne_error:0005"
      })
    }
    ...
    if (!isRoleIdValid.result) {
      return endMainFromError({
        hint: "Datapoint 'roleId' is not valid UUID.",
        errorIdentifier: "backendRoleManyPermission_deleteOne_error:0006"
      })
    }
    ...
    if (!doesRoleHavePermission.result) {
      return endMainFromError({
        ...
        errorIdentifier: "backendRoleManyPermission_deleteOne_error:0007"
      })
    }
