...
import { getDraftedPagesTotalGraphQL } from '../store/getDraftedPagesTotal.store';
...
export default function DraftedPagesTotalDataGrid() {
  ...
  useEffect(() => {
    getDraftedPagesTotalGraphQL({}).then(response => {
      const data = response.data.backendProjectStatusLists_getManyDraftedPagesTotalWithPagination || { rows: [] }
