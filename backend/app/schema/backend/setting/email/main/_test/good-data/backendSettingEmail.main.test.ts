...
import makeBackendSettingEmailMain from "../../backendSettingEmail.main";
jest.setTimeout(100000)


describe("test backendSettingEmail.main.js", () => {
  let d: dependencies
  let recordId: string
  ...
  test("updateOne: backendSetting_email can edit record.", async () => {
    const settingEmail = makeBackendSettingEmailMain(d)
  ...
  test("getOne: backendSetting_email can get record.", async () => {
    const settingEmail = makeBackendSettingEmailMain(d)
