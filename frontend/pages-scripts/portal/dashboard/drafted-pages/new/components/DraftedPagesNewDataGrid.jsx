...
import { getDraftedPagesNewGraphQL } from '../store/getDraftedPagesNew.store';
...
export default function DraftedPagesNewDataGrid() {
  ...
  useEffect(() => {
    getDraftedPagesNewGraphQL({}).then(response => {
      const data = response.data.backendProjectStatusLists_getManyDraftedPagesNewWithPagination || { rows: [] }
