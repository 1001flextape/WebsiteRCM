  ...
  return async (args: input[]): Promise<returningSuccessObj<Model<backendRole>[] | null>> => {
    ...
    if (!args || args?.length === 0) {
      return endMainFromError({
        ...
        errorIdentifier: "backendRole_addMany_error:0001",
      })
    }
    ...
    if (args.length > 50) {
      return endMainFromError({
        ...
        errorIdentifier: "backendRole_addMany_error:0002",
      })
    }
    ...
    if (names.length !== args.length) {
      return endMainFromError({
        ...
        errorIdentifier: "backendRole_addMany_error:0003"
      })
    }
    ...
    if (!namesWithinLength.result) {
      return endMainFromError({
        ...
        errorIdentifier: "backendRole_addMany_error:0004"
      })
    }
    ...
    if (areNamesTaken.result) {
      return endMainFromError({
        ...
        errorIdentifier: "backendRole_addMany_error:0005"
      })
    }
