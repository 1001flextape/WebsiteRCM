...
import { getNewPagesNotReadyGraphQL } from '../store/getNewPagesNotReady.store';
...
export default function NewPagesNotReadyDataGrid() {
  ...
  useEffect(() => {
    getNewPagesNotReadyGraphQL({}).then(response => {
      const data = response.data.backendProjectStatusLists_getManyNewPagesNotReadyWithPagination || { rows: [] }
