  ...
  return async (args: input): Promise<returningSuccessObj<Model<backendRole> | null>> => {
    ...
    if (!args.id) {
      return endMainFromError({
        ...
        errorIdentifier: "backendRole_updateOne_error:0001"
      })
    }
    ...
    if (!isIdStringFromUuid.result) {
      return endMainFromError({
        hint: "Datapoint 'id' is not UUID format.",
        errorIdentifier: "backendRole_updateOne_error:0002"
      })
    }
    ...
    if (!isIdValid.result) {
      return endMainFromError({
        ...
        errorIdentifier: "backendRole_updateOne_error:0003"
      })
    }
    ...
    if (!args.name) {
      return endMainFromError({
        ...
        errorIdentifier: "backendRole_updateOne_error:0004"
      })
    }
    ...
    if (args.name.length > 50) {
      return endMainFromError({
        ...
        errorIdentifier: "backendRole_updateOne_error:0005"
      })
    }
    ...
    if (isNameTaken.result) {
      return endMainFromError({
        ...
        errorIdentifier: "backendRole_updateOne_error:0006"
      })
    }
