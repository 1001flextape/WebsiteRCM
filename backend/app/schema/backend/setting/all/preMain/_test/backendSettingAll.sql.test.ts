...
import makeBackendSettingAllSql from "../backendSettingAll.sql";
jest.setTimeout(100000)


describe("test backendSettingAll.sql.js", () => {
  let d: dependencies
  ...
  test("isWebsiteSettingReady: is not Ready.", async () => {
    const settingAll = makeBackendSettingAllSql(d)
  ...
  test("isWebsiteSettingReady: is Ready.", async () => {    
    ...
    const settingAllSql = makeBackendSettingAllSql(d)
    const isWebsiteSettingReady = await settingAllSql.isWebsiteSettingReady()
