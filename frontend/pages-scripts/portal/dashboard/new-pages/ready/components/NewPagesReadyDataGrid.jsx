...
import { getNewPagesReadyGraphQL } from '../store/getNewPagesReady.store';
...
export default function NewPagesReadyDataGrid() {
  ...
  useEffect(() => {
    getNewPagesReadyGraphQL({}).then(response => {
      const data = response.data.backendProjectStatusLists_getManyNewPagesReadyWithPagination || { rows: [] }
