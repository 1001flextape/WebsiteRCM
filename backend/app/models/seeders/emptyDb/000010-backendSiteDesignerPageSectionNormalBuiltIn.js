...
async function up({ context: queryInterface }) {
  await queryInterface.bulkInsert('backendSiteDesignerPageSectionNormalBuiltIn', [
    
    {
      ...
      webAssetImport: "built-in/0.0.0/sections/section-header/",
    ...
    },
    {
      ...
      webAssetImport: "built-in/0.0.0/sections/half-image-half-paragraph/",
    ...
    },
    {
      ...
      webAssetImport: "built-in/0.0.0/sections/card-list/",
    ...
    },
    {
      ...
      webAssetImport: "built-in/0.0.0/sections/gallery/",
    ...
    },
    {
      ...
      webAssetImport: "built-in/0.0.0/sections/journal/",
      menuJsonB: '{}',
    ...
    },
    {
      ...
      webAssetImport: "built-in/0.0.0/sections/qna/",
      menuJsonB: '{}',
    ...
    },
    {
      ...
      webAssetImport: "built-in/0.0.0/sections/testimonials/",
      menuJsonB: '{}',
    ...
    },
    {
      ...
      webAssetImport: "built-in/0.0.0/sections/top-three-highlights/",
      menuJsonB: '{}',
...
async function down({ context: queryInterface }) {
  ...
  //   [Op.or]: [
  //     {
  //       webAssetImport: "built-in/0.0.0/headers/lite/",
  //     },
  //     {
  //       webAssetImport: "built-in/0.0.0/headers/smallBusinessFewPages/",
  //     },
  //     {
  //       webAssetImport: "built-in/0.0.0/headers/smallBusinessManyPages/",
  //     },
  //   ]
  // });
}
