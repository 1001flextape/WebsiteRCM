...
describe("test backendSiteDesigner_pageTemplate.main.js with bad data.", () => {
  ...
  test("backendRoleManyPermission_getAll_error:0001: works", async () => {
    ...
    expect(getAll.errorIdentifier).toEqual("backendRoleManyPermission_getAll_error:0001")
  })

  test("backendRoleManyPermission_getAll_error:0002: works", async () => {
    const backendRoleManyPermissionMain = makeBackendRoleManyPermissionMain(d)
    ...
    expect(getAll.success).toBe(false)
    expect(getAll.errorIdentifier).toEqual("backendRoleManyPermission_getAll_error:0002")
  })

  test("backendRoleManyPermission_getAll_error:0003: works", async () => {
    const backendRoleManyPermissionMain = makeBackendRoleManyPermissionMain(d)
    ...
    expect(getAll.success).toBe(false)
    expect(getAll.errorIdentifier).toEqual("backendRoleManyPermission_getAll_error:0003")
  })
