...
import makeBackendProjectStatusListsMain from "../../backendProjectStatusLists.main";
...
describe("test backendProjectHistoricalStatusLists.main.js", () => {
  let d: dependencies
  ...
  test("getConfigurationCount: get large count.", async () => {
    const counterMain = makeBackendProjectHistoricalStatusListsMain(d)

    const getConfigurationCount = await counterMain.getConfiguration({
      projectId: project1.id,
    })
  ...
  test("getManyDraftedPagesDeletedWithPagination: get records.", async () => {
    ...
    const getManyDraftedPagesDeletedWithPagination = await counterMain.getManyDraftedPagesDeletedWithPagination({
      projectId: project1.id,
    })
  ...
  test("getManyDraftedPagesNewWithPagination: get records.", async () => {
    ...
    const getManyDraftedPagesNewWithPagination = await counterMain.getManyDraftedPagesNewWithPagination({
      projectId: project1.id,
    })
  ...
  test("getManyDraftedPagesTotalWithPagination: get records.", async () => {
    ...
    const getManyDraftedPagesTotalWithPagination = await counterMain.getManyDraftedPagesTotalWithPagination({
      projectId: project1.id,
    })
  ...
  test("getManyPublishedPagesChangeWithPagination: get records.", async () => {
    ...
    const getManyPublishedPagesChangeWithPagination = await counterMain.getManyPublishedPagesChangeWithPagination({
      projectId: project1.id,
    })
  ...
  test("getManyPublishedPagesDeletedWithPagination: get records.", async () => {
    ...
    const getManyPublishedPagesDeletedWithPagination = await counterMain.getManyPublishedPagesDeletedWithPagination({
      projectId: project1.id,
    })
  ...
  test("getManyPublishedPagesNewWithPagination: get records.", async () => {
    ...
    const getManyPublishedPagesNewWithPagination = await counterMain.getManyPublishedPagesNewWithPagination({
      projectId: project1.id,
    })
  ...
  test("getManyPublishedPagesTotalWithPagination: get records.", async () => {
    ...
    const getManyPublishedPagesTotalWithPagination = await counterMain.getManyPublishedPagesTotalWithPagination({
      projectId: project1.id,
    })
