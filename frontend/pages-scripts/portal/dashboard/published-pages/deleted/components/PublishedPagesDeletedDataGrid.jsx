...
import { getPublishedPagesDeletedGraphQL } from '../store/getPublishedPagesDeleted.store';
...
export default function PublishedPagesDeletedDataGrid() {
  ...
  useEffect(() => {
    getPublishedPagesDeletedGraphQL({}).then(response => {
      const data = response.data.backendProjectStatusLists_getManyPublishedPagesDeletedWithPagination || { rows: [] }
