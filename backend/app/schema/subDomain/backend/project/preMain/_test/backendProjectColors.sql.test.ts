...
import makeBackendProjectColors from "../backendProjectColors.sql"
jest.setTimeout(100000)


describe("test backendProjectColors.sql.js", () => {

  let d: dependencies
  let record: backendProjectColors
  ...
  test("addOne: can add record.", async () => {
    const projectColors = makeBackendProjectColors(d)

    const addOne = await projectColors.addOne({
    ...
    expect(addOne.data.dataValues.color1).toEqual("color1")
    expect(addOne.data.dataValues.color1Dark1).toEqual("color1Dark1")
    expect(addOne.data.dataValues.color1Dark2).toEqual("color1Dark2")
    expect(addOne.data.dataValues.color1Dark3).toEqual("color1Dark3")
    expect(addOne.data.dataValues.color1Dark4).toEqual("color1Dark4")
    expect(addOne.data.dataValues.color1Light1).toEqual("color1Light1")
    expect(addOne.data.dataValues.color1Light2).toEqual("color1Light2")
    expect(addOne.data.dataValues.color1Light3).toEqual("color1Light3")
    expect(addOne.data.dataValues.color1Light4).toEqual("color1Light4")
    expect(addOne.data.dataValues.color2).toEqual("color2")
    expect(addOne.data.dataValues.color2Dark1).toEqual("color2Dark1")
    expect(addOne.data.dataValues.color2Dark2).toEqual("color2Dark2")
    expect(addOne.data.dataValues.color2Dark3).toEqual("color2Dark3")
    expect(addOne.data.dataValues.color2Dark4).toEqual("color2Dark4")
    expect(addOne.data.dataValues.color2Light1).toEqual("color2Light1")
    expect(addOne.data.dataValues.color2Light2).toEqual("color2Light2")
    expect(addOne.data.dataValues.color2Light3).toEqual("color2Light3")
    expect(addOne.data.dataValues.color2Light4).toEqual("color2Light4")
    expect(addOne.data.dataValues.color3).toEqual("color3")
    expect(addOne.data.dataValues.color3Dark1).toEqual("color3Dark1")
    expect(addOne.data.dataValues.color3Dark2).toEqual("color3Dark2")
    expect(addOne.data.dataValues.color3Dark3).toEqual("color3Dark3")
    expect(addOne.data.dataValues.color3Dark4).toEqual("color3Dark4")
    expect(addOne.data.dataValues.color3Light1).toEqual("color3Light1")
    expect(addOne.data.dataValues.color3Light2).toEqual("color3Light2")
    expect(addOne.data.dataValues.color3Light3).toEqual("color3Light3")
    expect(addOne.data.dataValues.color3Light4).toEqual("color3Light4")
    expect(addOne.data.dataValues.color4).toEqual("color4")
    expect(addOne.data.dataValues.color4Dark1).toEqual("color4Dark1")
    expect(addOne.data.dataValues.color4Dark2).toEqual("color4Dark2")
    expect(addOne.data.dataValues.color4Dark3).toEqual("color4Dark3")
    expect(addOne.data.dataValues.color4Dark4).toEqual("color4Dark4")
    expect(addOne.data.dataValues.color4Light1).toEqual("color4Light1")
    expect(addOne.data.dataValues.color4Light2).toEqual("color4Light2")
    expect(addOne.data.dataValues.color4Light3).toEqual("color4Light3")
    expect(addOne.data.dataValues.color4Light4).toEqual("color4Light4")
    expect(addOne.data.dataValues.color5).toEqual("color5")
    expect(addOne.data.dataValues.color5Dark1).toEqual("color5Dark1")
    expect(addOne.data.dataValues.color5Dark2).toEqual("color5Dark2")
    expect(addOne.data.dataValues.color5Dark3).toEqual("color5Dark3")
    expect(addOne.data.dataValues.color5Dark4).toEqual("color5Dark4")
    expect(addOne.data.dataValues.color5Light1).toEqual("color5Light1")
    expect(addOne.data.dataValues.color5Light2).toEqual("color5Light2")
    expect(addOne.data.dataValues.color5Light3).toEqual("color5Light3")
    expect(addOne.data.dataValues.color5Light4).toEqual("color5Light4")
    expect(addOne.data.dataValues.color6).toEqual("color6")
    expect(addOne.data.dataValues.color6Dark1).toEqual("color6Dark1")
    expect(addOne.data.dataValues.color6Dark2).toEqual("color6Dark2")
    expect(addOne.data.dataValues.color6Dark3).toEqual("color6Dark3")
    expect(addOne.data.dataValues.color6Dark4).toEqual("color6Dark4")
    expect(addOne.data.dataValues.color6Light1).toEqual("color6Light1")
    expect(addOne.data.dataValues.color6Light2).toEqual("color6Light2")
    expect(addOne.data.dataValues.color6Light3).toEqual("color6Light3")
    expect(addOne.data.dataValues.color6Light4).toEqual("color6Light4")
    expect(addOne.data.dataValues.color7).toEqual("color7")
    expect(addOne.data.dataValues.color7Dark1).toEqual("color7Dark1")
    expect(addOne.data.dataValues.color7Dark2).toEqual("color7Dark2")
    expect(addOne.data.dataValues.color7Dark3).toEqual("color7Dark3")
    expect(addOne.data.dataValues.color7Dark4).toEqual("color7Dark4")
    expect(addOne.data.dataValues.color7Light1).toEqual("color7Light1")
    expect(addOne.data.dataValues.color7Light2).toEqual("color7Light2")
    expect(addOne.data.dataValues.color7Light3).toEqual("color7Light3")
    expect(addOne.data.dataValues.color7Light4).toEqual("color7Light4")
    expect(addOne.data.dataValues.color8).toEqual("color8")
    expect(addOne.data.dataValues.color8Dark1).toEqual("color8Dark1")
    expect(addOne.data.dataValues.color8Dark2).toEqual("color8Dark2")
    expect(addOne.data.dataValues.color8Dark3).toEqual("color8Dark3")
    expect(addOne.data.dataValues.color8Dark4).toEqual("color8Dark4")
    expect(addOne.data.dataValues.color8Light1).toEqual("color8Light1")
    expect(addOne.data.dataValues.color8Light2).toEqual("color8Light2")
    expect(addOne.data.dataValues.color8Light3).toEqual("color8Light3")
    expect(addOne.data.dataValues.color8Light4).toEqual("color8Light4")
    expect(addOne.data.dataValues.color9).toEqual("color9")
    expect(addOne.data.dataValues.color9Dark1).toEqual("color9Dark1")
    expect(addOne.data.dataValues.color9Dark2).toEqual("color9Dark2")
    expect(addOne.data.dataValues.color9Dark3).toEqual("color9Dark3")
    expect(addOne.data.dataValues.color9Dark4).toEqual("color9Dark4")
    expect(addOne.data.dataValues.color9Light1).toEqual("color9Light1")
    expect(addOne.data.dataValues.color9Light2).toEqual("color9Light2")
    expect(addOne.data.dataValues.color9Light3).toEqual("color9Light3")
    expect(addOne.data.dataValues.color9Light4).toEqual("color9Light4")
  ...
  test("getOneById: can get record.", async () => {
    ...
    const getOne = await projectColors.getOneById({
      id: record.id
    })
  ...
  test("getOneByProjectId: can get record.", async () => {
    ...
    const getOne = await projectColors.getOneByProjectId({
      projectId: project.id,
    })
